...
var useUtilityClasses$2 = (ownerState, componentName) => {
...
function createContainer(options = {}) {
	...
	const Container = /*#__PURE__*/ import_react.forwardRef(function Container(inProps, ref) {
		...
		return /*#__PURE__*/ (0, import_jsx_runtime.jsx)(ContainerRoot, {
			as: component,
			ownerState,
			className: clsx(useUtilityClasses$2(ownerState, componentName).root, className),
			ref,
			...other
		});
	});
...
//#endregion
export { alpha as $, shouldSkipGeneratingVar as A, styleFunctionSx_default as At, blue as B, composeClasses as Bt, GlobalStyles as C, styled$2 as Ct, createTheme as D, createCache as Dt, defaultTheme as E, CacheProvider as Et, easing as F, mergeBreakpointsInOrder as Ft, common as G, red as H, require_prop_types as Ht, createTypography as I, resolveBreakpointValues as It, InitColorSchemeScript as J, createContainer as K, createMixins as L, createBreakpoints as Lt, getOverlayAlpha as M, getValue as Mt, createTransitions as N, getPath as Nt, createThemeWithVars as O, StyleSheet as Ot, duration as P, handleBreakpoints as Pt, exactProp as Q, green as R, deepmerge as Rt, slotShouldForwardProp as S, createSpacing as St, identifier_default as T, keyframes as Tt, purple as U, orange as V, clsx as Vt, grey as W, useId as X, ThemeProvider as Y, useRtl as Z, useDefaultProps as _, generateUtilityClass as _t, isEventHandler as a, hexToRgb as at, styled as b, useTheme$3 as bt, isHostComponent as c, recomposeColor as ct, getAvatarUtilityClass as d, useEnhancedEffect as dt, darken as et, createSvgIcon as f, useThemeProps as ft, capitalize_default as g, generateUtilityClasses as gt, svgIconClasses as h, styled$1 as ht, extractEventHandlers as i, getLuminance as it, createColorScheme as j, createUnarySpacing as jt, excludeVariablesFromRoot as k, _extends as kt, useForkRef as l, rgbToHex as lt, getSvgIconUtilityClass as m, resolveProps as mt, useSlot as n, emphasize as nt, resolveComponentProps as o, hslToRgb as ot, SvgIcon as p, getThemeProps$1 as pt, createCssVarsProvider as q, mergeSlotProps as r, getContrastRatio as rt, appendOwnerState as s, lighten as st, Avatar as t, decomposeColor as tt, avatarClasses as u, clamp as ut, memoTheme as v, ClassNameGenerator as vt, useTheme as w, css as wt, rootShouldForwardProp as x, createTheme$1 as xt, globalCss as y, useTheme$2 as yt, lightBlue as z, require_react_is$1 as zt };

//# sourceMappingURL=Avatar-UR1JdJv6.js.map