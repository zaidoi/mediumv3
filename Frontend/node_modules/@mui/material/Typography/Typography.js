...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, ownerState.align !== 'inherit' && `align${(0, _capitalize.default)(align)}`, gutterBottom && 'gutterBottom', noWrap && 'noWrap']
  };
...
const TypographyRoot = exports.TypographyRoot = (0, _zeroStyled.styled)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, ownerState.variant && styles[ownerState.variant], ownerState.align !== 'inherit' && styles[`align${(0, _capitalize.default)(ownerState.align)}`], ownerState.noWrap && styles.noWrap, ownerState.gutterBottom && styles.gutterBottom];
  }
